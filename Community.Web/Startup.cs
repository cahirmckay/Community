...
namespace Community.Web
{
    public class Startup
    {
        ...
        {   
            ...
            services.AddTransient<IEnvironmentService, EnvironmentServiceDb>();
            services.AddTransient<ILocationService, LocationServiceDb>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider provider)
        {
            if (env.IsDevelopment())
            {
                ...
                provider.GetService<IBookingService>(), provider.GetService<IEnvironmentService>(), provider.GetService<ILocationService>());
            }
            else
            {
